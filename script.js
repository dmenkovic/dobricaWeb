var questions = [
  ...
  },
  {
    ...
    {
    question: "Where is the turquoise?",
    answers: [
      {text: "blue"},
      {text: "orange"},
...
function updateQuestionAndScore() {
  if (iQuestion >= questions.length) { // prikaz rezultata kada iQuestion = 9
  	document.getElementsByClassName('htwo')[0].outerHTML = '<h2 onclick="myFunction()" style="color:#46af62;border:1.5px solid blue; border-radius:10px; width:20%; margin:15px auto;cursor:pointer;">Start again</h2>';
